...
public class OutOfStockItemVariantsAdapter extends RecyclerView.Adapter<OutOfStockItemVariantsAdapter.OutOfStockItemVariantsViewHolder> {

    Context context;
    ArrayList<ItemVariantsModel> variants_list = new ArrayList();
    int parent_position;

    public OutOfStockItemVariantsAdapter(Context context, ArrayList<ItemVariantsModel> variants_list, int parent_position) {
    ...
    @NonNull
    @Override
    public OutOfStockItemVariantsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_variants_item, parent, false);
        return new OutOfStockItemVariantsAdapter.OutOfStockItemVariantsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OutOfStockItemVariantsViewHolder holder, int position) {
...
//                                    notifyItemChanged(position);
    ...
    public class OutOfStockItemVariantsViewHolder extends RecyclerView.ViewHolder {

        TextView variant_weight;
        TextView variant_price;
        SwitchMaterial variantSwitch;

        public OutOfStockItemVariantsViewHolder(@NonNull View itemView) {
            super(itemView);
