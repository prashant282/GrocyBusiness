...
public class OutOfStockItemFragment extends Fragment {
    ...
    public static OutOfStockItemAdapter outOfStockItemAdapter;
...
//        });
    ...
    private void setAdapter(View view) {
        ...
        outOfStockItemAdapter = new OutOfStockItemAdapter(view.getContext());

        recyclerView.setAdapter(outOfStockItemAdapter);

//        for (Map.Entry mapElement : AllItemFragment.all_items.entrySet()) {
